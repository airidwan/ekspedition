...
@section('title', trans('accountreceivables/menu.invoice-do'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-credit-card"></i> <strong>{{ $title }}</strong> {{ trans('accountreceivables/menu.invoice-do') }}</h2>
                                               ...
                                               <?php $indexLine = 0; ?>
                                                ...
                                                <tr data-index-line="{{ $indexLine }}">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <input type="hidden" name="doNumber[]" value="{{ old('resiNumber')[$i] }}">
                                                ...
                                                <tr data-index-line="{{ $indexLine }}">
                                                    <td >
                                                        ...
                                                        {{ !empty($line->doLine->header) ? $line->doLine->header->do_number : '' }}
                                                    </td>
                                                    <td >
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <input type="hidden" name="doNumber[]" value="{{ !empty($line->doLine->header) ? $line->doLine->header->do_number : '' }}">
                        ...
                        <div id="horizontal-form">
                            <form  role="form" id="add-form" class="form-horizontal" method="post">
                                ...
                                <div class="col-sm-6 portlets">
                                    ...
                                    <div class="form-group">
                                        <label for="doNumber" class="col-sm-4 control-label">
                                            {{ trans('operational/fields.do-number') }} <span class="required">*</span>
                                        </label>
                                        <div class="col-sm-8">
                                            <input type="hidden" name="doLineId" id="doLineId" value="">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <table id="table-lov-resi" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>{{ trans('operational/fields.resi-number') }}<hr/>{{ trans('operational/fields.do-number') }}</th>
        ...
        success: function(data) {
            ...
            data.forEach(function(item) {
                ...
                $('#table-lov-resi tbody').append(
                    '<tr data-json=\'' + JSON.stringify(item) + '\'>\
                        <td>' + item.resi_number + '<hr/>' + item.delivery_order_number + '</td>\
                        <td>' + item.route_code + '</td>\
                        <td>' + customerName + '<hr/>' + item.sender_name + '</td>\
                        <td>' + customerReceiverName + '<hr/>' + item.receiver_name + '</td>\
                        <td class="text-right">' + item.delivery_cost.formatMoney(0) + '</td>\
                    </tr>'
                );
            });
...
var selectResi = function() {
    ...
    $('#doLineId').val(data.delivery_order_line_id);
    ...
    $('#amount').val(data.delivery_cost.formatMoney(0));
    calculateAmountLine();
...
var saveLine = function() {
    ...
    var htmlTr = '<td >' + resiNumber + ' <hr/> ' + doNumber + '</td>\
                    ...
                    <td class="text-center">\
                        ...
                        <input type="hidden" name="doLineId[]" value="' + doLineId + '">\
