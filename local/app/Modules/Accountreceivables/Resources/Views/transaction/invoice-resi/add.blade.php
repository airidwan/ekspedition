    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-credit-card"></i> <strong>{{ $title }}</strong> {{ trans('accountreceivables/menu.invoice-resi') }}</h2>
                                        ...
                                        <table class="table table-striped table-bordered" id="table-line" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                               <?php $indexLine = 0; ?>
                                                ...
                                                <tr data-index-line="{{ $indexLine }}">
                                                    <td > {{ !empty($line->resi) ? $line->resi->resi_number : '' }} </td>
                                                    <td >
            ...
            data.forEach(function(item) {
                ...
                $('#table-lov-resi tbody').append(
                    '<tr data-json=\'' + JSON.stringify(item) + '\'>\
                        ...
                        <td class="text-right">' + item.total.formatMoney(0) + '</td>\
                    </tr>'
                );
            });
...
var selectResi = function() {
    ...
    $('#amount').val(data.total.formatMoney(0));
    calculateAmountLine();
