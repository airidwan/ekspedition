                ...
                <div id="horizontal-form">
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            ...
                            <div class="form-group">
                                <label for="namaBank" class="col-sm-4 control-label">{{ trans('accountreceivables/fields.nama-bank') }}</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="namaBank" name="namaBank" value="{{ !empty($filters['namaBank']) ? $filters['namaBank'] : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 portlets">
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                            <div class="form-group">
                                ...
                                <a href="{{ URL('accountreceivables/master/master-payment-ways/add') }}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('accountreceivables/fields.nama-bank') }}</th>
                                    <th>{{ trans('accountreceivables/fields.rekening-bank') }}</th>
