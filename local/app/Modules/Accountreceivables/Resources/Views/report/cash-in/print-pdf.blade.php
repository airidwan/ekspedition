...
<table class="table" cellspacing="0" cellpadding="2">
    <tbody>
        ...
        <tr>
            ...
            <td width="2%">:</td>
            <td width="75%">{{ 'Invoice No. ' . $model->invoice->invoice_number }}</td>
        </tr>
        <tr>
            <td width="23%"></td>
            <td width="2%"></td>
            <td width="75%">{{ 'Resi No. ' . $model->invoice->resi->resi_number }}</td>
        </tr>
        <tr>
            <td width="23%"></td>
            <td width="2%"></td>
            <td width="75%">{{ $model->invoice->resi->route->route_code }}</td>
        </tr>
        <tr>
            <td width="23%"></td>
            <td width="2%"></td>
            <td width="75%">{{ $model->invoice->isInvoiceExtraCost() ? $model->invoice->description : '' }}</td>
        </tr>
    </tbody>
</table>
