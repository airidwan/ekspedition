...
{
    /**
     * Register the Purchasing module service provider.
     *
    ...
    {
        App::register('App\Modules\Purchasing\Providers\RouteServiceProvider');

        Lang::addNamespace('purchasing', realpath(__DIR__.'/../Resources/Lang'));
        View::addNamespace('purchasing', base_path('resources/views/vendor/purchasing'));
        View::addNamespace('purchasing', realpath(__DIR__.'/../Resources/Views'));
    }
