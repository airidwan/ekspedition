...
@section('title', trans('asset/menu.mask-add-asset'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-folder"></i> {{ trans('asset/menu.mask-add-asset') }}</h2>
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('inventory/fields.quantity') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $model->jumlah }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<div class="md-modal md-3d-flip-horizontal" id="modal-delete">
    <div class="md-content">
        <h3 style="padding-bottom: 0px;"><strong>{{ trans('shared/common.delete') }}</strong> {{ trans('asset/menu.mask-add-asset') }}</h3>
        <div>
            <div class="row">
                <div class="col-sm-12">
...
$(document).on('ready', function(){
    ...
    $('.delete-action').on('click', function() {
        ...
        $("#delete-text").html('{{ trans('shared/common.delete-confirmation', ['variable' => trans('asset/menu.mask-add-asset')]) }} ' + $(this).data('label') + '?');
    });
});
</script>
@endsection
