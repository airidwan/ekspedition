...
@section('title', trans('asset/menu.truck-monthly-maintenance'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-folder"></i> {{ trans('asset/menu.truck-monthly-maintenance') }}</h2>
                    ...
                    <form class='form-horizontal' role='form' id="table-line">
                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="8" class="text-center"><strong>{{ trans('shared/common.total') }}</strong></td>
                                    <td class="text-right"><strong>{{ number_format($totalPurchaseOrder) }}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><strong>{{ number_format($totalMoveOrder) }}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
