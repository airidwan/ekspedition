...
<table id="filtes" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td width="50%" cellpadding="0" cellspacing="0">
            <table>
                <tr>
                    <td width="38%">{{ trans('payable/fields.partner') }}</td>
                    <td width="2%">:</td>
...
<table class="table" cellspacing="0" cellpadding="2" border="0">
    <thead>
        <tr>
            ...
            <th width="15%" style="border: 1px solid black">{{ trans('operational/fields.total-coly') }}</th>
    ...
    <tbody>
         ...
         <?php  
            ...
            $doLine    = $modelLine->deliveryOrderLine;
            $resi      = $doLine->resi;
        ?>
        <tr>
            <td width="5%" align="center" style="border: 1px solid black">{{ $no++ }}</td>
            <td width="15%" style="border: 1px solid black">{{ !empty($resi) ? $resi->resi_number : '' }}</td>
            <td width="20%" style="border: 1px solid black">{{ !empty($resi) ? $resi->item_name : '' }}</td>
            <td width="15%" align="right" style="border: 1px solid black">{{ !empty($doLine) ? $doLine->total_coly : '' }}</td>
