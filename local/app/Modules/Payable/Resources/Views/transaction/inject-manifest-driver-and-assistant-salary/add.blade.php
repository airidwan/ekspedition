                            ...
                            <div class="tab-pane fade active in" id="tabDriverSalary">
                                ...
                                <div class="col-sm-6 portlets">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class='form-control' id="driverAssistant" name="driverAssistant" value="{{ !empty($model->driverAssistant) ? $model->driverAssistant->driver_code.' - '.$model->driverAssistant->driver_name : '' }}" disabled />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="driverAssistantPosition" class="col-sm-4 control-label">{{ trans('operational/fields.position') }}</label>
                                        <div class="col-sm-8">
                                            <input type="text" class='form-control' id="driverAssistantPosition" name="driverAssistantPosition" value="{{ !empty($model->driverAssistant) ? $model->driverAssistant->position : '' }}" disabled />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="driverAssistantType" class="col-sm-4 control-label">{{ trans('operational/fields.type') }}</label>
                                        <div class="col-sm-8">
                                            <input type="text" class='form-control' id="driverAssistantType" name="driverAssistantType" value="{{ !empty($model->driverAssistant) ? $model->driverAssistant->type : '' }}" disabled />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="driverAssistantSalary" class="col-sm-4 control-label">{{ trans('payable/fields.driver-assistant-salary') }}</label>
                                        <div class="col-sm-8">
                                            <input type="text" class='form-control currency' id="driverAssistantSalary" name="driverAssistantSalary" value="{{ count($errors) > 0 ? str_replace(',', '', old('driverAssistantSalary')) : $model->driver_assistant_salary }}" {{ empty($model->driverAssistant) || !$model->driverAssistant->isTripEmployee() ? 'readonly' : '' }}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
