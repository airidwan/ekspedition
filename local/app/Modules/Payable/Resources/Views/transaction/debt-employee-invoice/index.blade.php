                        ...
                        <tbody>
                            ...
                            @foreach($models as $model)
                             <?php
                                 ...
                                 $modelInvoice = InvoiceHeader::find($model->header_id);
                             ?>
                            <tr>
                                ...
                                <td>{{ $model->vendor_phone_number }}</td>
                                @else
                                ...
                                @endif
                                <td class="text-right">{{ number_format($modelInvoice->getTotalInvoice()) }}</td>
                                <td>{{ !empty($date) ? $date->format('d-M-Y') : '' }}</td>
                                <td>{{ $model->description }}</td>
                                <td>{{ $model->status }}</td>
                                <td class="text-center">
                                    <i class="fa {{ $modelInvoice->is_invoice ? 'fa-check' : 'fa-remove' }}"></i>
                                </td>
                                <td class="text-center" >
...
<script type="text/javascript">
    $(document).on('ready', function(){
        $('.delete-action').on('click', function() {
            ...
            $("#delete-text").html('{{ trans('shared/common.delete-confirmation', ['variable' => trans('payable/menu.debt-employee-invoice')]) }} ' + $(this).data('label') + '?');
        });

        $('.cancel-action').on('click', function() {
            $("#cancel-id").val($(this).data('id'));
            $("#cancel-text").html('{{ trans('purchasing/fields.cancel-confirmation', ['variable' => trans('payable/menu.debt-employee-invoice')]) }} ' + $(this).data('label') + '?');
            clearFormCancel()
        });
