...
<table class="table" cellspacing="0" cellpadding="2" border="0">
    <thead>
        <tr>
            ...
            <th width="15%" style="border: 1px solid black">{{ trans('purchasing/fields.po-number') }}</th>
            ...
            <th width="15%" style="border: 1px solid black">{{ trans('payable/fields.interest') }}</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="15%" style="border: 1px solid black">{{ !empty($po) ? $po->po_number : '' }}</td>
            <td width="20%" style="border: 1px solid black">{{ !empty($po) ? $po->description : '' }}</td>
            <td width="15%" align="right" style="border: 1px solid black">{{ number_format($line->amount) }}</td>
            <td width="15%" align="right" style="border: 1px solid black">{{ number_format($line->interest_bank) }}</td>
