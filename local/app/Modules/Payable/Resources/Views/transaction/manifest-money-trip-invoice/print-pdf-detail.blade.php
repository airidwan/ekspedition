...
<table class="table" cellspacing="0" cellpadding="2" border="0">
    <thead>
        <tr>
            ...
            <th width="30%" style="border: 1px solid black">{{ trans('operational/fields.manifest-number') }}</th>
    ...
    <tbody>
         ...
         <?php  
            $line = InvoiceLine::find($line->line_id);
        ?>
        <tr>
            <td width="5%" align="center" style="border: 1px solid black">{{ $no++ }}</td>
            <td width="30%" style="border: 1px solid black">{{ $model->manifest->manifest_number }}</td>
            <td width="20%" style="border: 1px solid black">{{ $model->manifest->description }}</td>
            <td width="15%" align="right" style="border: 1px solid black">{{ number_format($line->amount) }}</td>
            <td width="15%" align="right" style="border: 1px solid black">{{ number_format($line->totalTax()) }}</td>
            <td width="15%" align="right" style="border: 1px solid black">{{ number_format($line->totalAmount()) }}</td>
        </tr>
        @endforeach
        <tr>
