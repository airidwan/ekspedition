                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    {{ trans('operational/fields.do-number') }}<hr/>
                        ...
                        <tbody>
                            ...
                            <?php
                            $model = DeliveryOrderHeader::find($model->delivery_order_header_id);
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ $model->delivery_order_number }}<hr/>
                                ...
                                <td>
                                    {{ $model->assistant !== null ? $model->assistant->driver_code . ' - ' . $model->assistant->driver_name : '' }}<hr/>
                                    {{ $model->assistant !== null ? $model->assistant->type : '' }}
                                </td>
