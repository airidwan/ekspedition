                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="vendorName" name="vendorName" value="{{ !empty($filters['vendorName']) ? $filters['vendorName'] : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 portlets">
                        ...
                        <tbody>
                            ...
                            @foreach($models as $model)
                             <?php
                                 ...
                                 $po    = PurchaseOrderHeader::find($model->po_header_id);
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ number_format(!empty($invoice) ? $invoice->getTotalInvoice() : 0) }}</td>
...
<div class="md-modal md-3d-flip-horizontal" id="modal-cancel">
    <div class="md-content">
        <h3 style="padding-bottom: 0px;"><strong>{{ trans('shared/common.cancel') }}</strong> {{ trans('payable/menu.dp-invoice') }}</h3>
        <div>
            <div class="row">
                <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).on('ready', function(){
        $('.delete-action').on('click', function() {
            ...
            $("#delete-text").html('{{ trans('shared/common.delete-confirmation', ['variable' => trans('payable/menu.dp-invoice')]) }} ' + $(this).data('label') + '?');
        });

        $('.cancel-action').on('click', function() {
            $("#cancel-id").val($(this).data('id'));
            $("#cancel-text").html('{{ trans('purchasing/fields.cancel-confirmation', ['variable' => trans('payable/menu.dp-invoice')]) }} ' + $(this).data('label') + '?');
            clearFormCancel()
        });
