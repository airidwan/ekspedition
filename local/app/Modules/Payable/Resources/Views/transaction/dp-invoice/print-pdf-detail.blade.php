...
<table class="table" cellspacing="0" cellpadding="2" border="0">
    <thead>
        <tr>
            ...
            <th width="20%" style="border: 1px solid black">{{ trans('purchasing/fields.po-number') }}</th>
            <th width="30%" style="border: 1px solid black">{{ trans('shared/common.description') }}</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="20%" style="border: 1px solid black">{{ !empty($po) ? $po->po_number : '' }}</td>
            <td width="30%" style="border: 1px solid black">{{ !empty($po) ? $po->description : '' }}</td>
