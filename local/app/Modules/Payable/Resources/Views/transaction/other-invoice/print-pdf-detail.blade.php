...
<table class="table" cellspacing="0" cellpadding="2" border="0">
    <thead>
        <tr>
            ...
            <th width="25%" style="border: 1px solid black">{{ trans('shared/common.description') }}</th>
            <th width="25%" style="border: 1px solid black">{{ trans('general-ledger/fields.account') }}</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="25%" style="border: 1px solid black">{{ $line->description }}</td>
            <td width="25%" style="border: 1px solid black">{{ $line->accountCombination->account->description }}</td>
