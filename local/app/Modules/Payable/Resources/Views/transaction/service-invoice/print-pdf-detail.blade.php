...
<table id="filtes" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td width="50%" cellpadding="0" cellspacing="0">
            <table>
                <tr>
                    <td width="38%">{{ trans('payable/fields.vendor') }}</td>
                    <td width="2%">:</td>
...
<table class="table" cellspacing="0" cellpadding="2" border="0">
    <thead>
        <tr>
            ...
            <th width="15%" style="border: 1px solid black">{{ trans('asset/fields.service-number') }}</th>
            <th width="15%" style="border: 1px solid black">{{ trans('asset/fields.asset-number') }}</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="15%" style="border: 1px solid black">{{ $modelLine->service->service_number }}</td>
            <td width="15%" style="border: 1px solid black">{{ $modelLine->service->addAsset->asset_number }}</td>
            <td width="20%" style="border: 1px solid black">{{ $modelLine->service->note }}</td>
