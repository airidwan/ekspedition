                ...
                <div id="horizontal-form">
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            ...
                            <div class="form-group">
                                <label for="doPickupNumber" class="col-sm-4 control-label">{{ trans('operational/fields.do-pickup-number') }}</label>
                                <div class="col-sm-8">
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('operational/fields.do-pickup-number') }}</th>
...
<script type="text/javascript">
    $(document).on('ready', function(){
        $('.delete-action').on('click', function() {
            ...
            $("#delete-text").html('{{ trans('shared/common.delete-confirmation', ['variable' => trans('payable/menu.do-pickup-money-trip-invoice')]) }} ' + $(this).data('label') + '?');
        });

        $('.cancel-action').on('click', function() {
            $("#cancel-id").val($(this).data('id'));
            $("#cancel-text").html('{{ trans('purchasing/fields.cancel-confirmation', ['variable' => trans('payable/menu.do-pickup-money-trip-invoice')]) }} ' + $(this).data('label') + '?');
            clearFormCancel()
        });
