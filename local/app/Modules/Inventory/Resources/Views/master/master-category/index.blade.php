    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-briefcase"></i> {{ trans('inventory/menu.master-category') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            <div class="form-group">
                                <label for="categoryCode" class="col-sm-4 control-label">{{ trans('inventory/fields.category-code') }}</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="categoryCode" name="categoryCode" value="{{ !empty($filters['categoryCode']) ? $filters['categoryCode'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('inventory/fields.category-code') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ URL($url . '/edit/' . $model->category_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
