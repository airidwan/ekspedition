    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-briefcase"></i> {{ trans('inventory/menu.master-item') }}</h2>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="category" name="category">
                                        ...
                                        <option value="{{ $category->category_id }}" {{ !empty($filters['category']) && $filters['category'] == $category->category_id ? 'selected' : '' }}>{{ $category->description }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ URL($url . '/edit/' . $model->item_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
