...
@section('title', trans('inventory/menu.move-order-all-branch'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-briefcase"></i> {{ trans('inventory/menu.move-order-all-branch') }}</h2>
...
<div class="md-modal md-3d-flip-horizontal" id="modal-cancel">
    <div class="md-content">
        <h3 style="padding-bottom: 0px;"><strong>{{ trans('shared/common.cancel') }}</strong> {{ trans('inventory/menu.move-order-all-branch') }}</h3>
        <div>
            <div class="row">
                <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).on('ready', function(){
        ...
        $('.cancel-action').on('click', function() {
            ...
            $("#cancel-text").html('{{ trans('purchasing/fields.cancel-confirmation', ['variable' => trans('inventory/menu.move-order-all-branch')]) }} ' + $(this).data('label') + '?');
            clearFormCancel()
        });
