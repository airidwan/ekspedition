    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.cost-delivery-order') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input style="text-transform: uppercase" type="text" class="form-control" id="policeNumber" name="policeNumber" value="{{ !empty($filters['policeNumber']) ? $filters['policeNumber'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ URL(DeliveryOrderController::URL.'/print-pdf-detail/'.$model->delivery_order_header_id) }}" class="button btn btn-xs btn-success" target="_blank">
