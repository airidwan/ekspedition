...
<style type="text/css">
table { font-size: 9px }
.web { font-size: 10px; font-weight: bold; color: white; }
.ujpt { font-size: 10px; color: white; }
.branch { font-size: 6px; }
.branch-title { font-weight: bold; color: white; }
.surat-jalan { font-size: 15px; font-weight: bold; color: white; }
...
.resi-date, { font-size: 14px; font-weight: bold; }
.resi-number, { font-size: 22px; font-weight: bold; }
.sender, .receiver, { font-weight: bold; }
.customer-code { font-size: 8px; font-weight: bold; }
.route-city { font-size: 10px; font-weight: bold; }
.translate { font-weight: normal; font-size: 6px; font-style: italic; color: white; }
.column-title { font-weight: bold; color: white; }
.syarat-ketentuan-pengiriman { font-size: 7px; color: white; }
.keterangan-ketentuan-pengiriman { color: red; color: white; }
.pengaduan-pelanggan { color: red; font-weight: bold; font-size: 8px; color: white; }
.amounts { font-size: 10px; font-weight: bold; }
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <td width="50%" >
            <table width="100%" class="sender" cellspacing="0" cellpadding="2">
                <tr>
                    ...
                    <td width="3%">&nbsp;</td>
                    <td width="45%" >{{ !empty($model->customer) ? $model->customer->customer_name : $model->sender_name }}</td>
                ...
                <tr>
                    ...
                    <td width="3%">&nbsp;</td>
                    <td width="80%" height="55px" colspan="2">{{ $model->sender_address }}</td>
                </tr>
                <tr>
                    <td width="17%">&nbsp;<br/><span class="translate">Phone</span></td>
                    <td width="3%">&nbsp;</td>
                    <td width="45%">{{ $model->sender_phone }}</td>
        ...
        <td width="50%" >
            <table width="100%" class="receiver" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    <td width="17%">&nbsp;<br/><span class="translate">Address</span></td>
                    <td width="3%">&nbsp;</td>
                    <td width="80%" height="55px" colspan="2">{{ $model->receiver_address }}</td>
                </tr>
                <tr>
                    <td width="17%">&nbsp;<br/><span class="translate">Phone</span></td>
                    <td width="3%">&nbsp;</td>
                    <td width="45%">{{ $model->receiver_phone }}</td>
    ...
    <tr>
        <td align="center" width="12%" class="column-title" height="29px">Jumlah Coly<br/><span class="translate">Total Colly</span></td>
    ...
    <tr>
        <td align="center" height="105px" rowspan="2">{{ $model->totalColy() }} Koli</td>
        <td align="center" height="105px" rowspan="2">
        ...
        <td align="center" height="105px" rowspan="2"><b>{{ $model->item_name }}</b></td>
        <td align="center" height="50px"><span class="valign-amount">&nbsp;<br/></span><b>Rp {{ !$tanpaBiaya ? number_format($model->totalAmount()) : 0 }}</b></td>
        <td align="center" height="105px" rowspan="2">
    ...
    <tr>
        ...
        <td width="25%">
            <table width="100%" class="amounts" cellspacing="0" cellpadding="2" border="0">
                ...
                <tr>
                    <td height="22px" class="total-amount">&nbsp;</td>
                    <td>&nbsp;</td>
