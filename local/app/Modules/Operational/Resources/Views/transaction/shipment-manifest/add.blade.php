...
@section('title', trans('operational/menu.shipment-manifest'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> <strong>{{ $title }}</strong> {{ trans('operational/menu.shipment-manifest') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="{{ url($url . '/save') }}">
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                           <div class="form-group">
                                ...
                                @if ($model->isApproved() && $model->money_trip !== null)   
                                <button type="submit" name="btn-otr" class="btn btn-sm btn-info"><i class="fa fa-truck"></i> {{ trans('operational/fields.otr') }}</button>
                                @endif
                            </div>
                        </div>
                    </form>
