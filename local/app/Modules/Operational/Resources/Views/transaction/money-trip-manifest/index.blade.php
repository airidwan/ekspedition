...
@section('title', trans('operational/menu.money-trip-manifest'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.money-trip-manifest') }}</h2>
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ number_format($model->money_trip) }}</td>
                                <td>{{ $model->status }}</td>
