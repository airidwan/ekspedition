...
<?php use App\Modules\Operational\Model\Transaction\DraftDeliveryOrderHeader; ?>
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.draft-delivery-order') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            <div class="form-group">
                                <label for="deliveryOrderNumber" class="col-sm-4 control-label">{{ trans('operational/fields.draft-do-number') }}</label>
                                <div class="col-sm-8">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ URL($url . '/edit/' . $model->draft_delivery_order_header_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    @if(in_array($model->status, DraftDeliveryOrderHeader::canPrint()))
                                    <a href="{{ URL($url . '/print-pdf-detail/' . $model->draft_delivery_order_header_id) }}" target="_blank" data-toggle="tooltip" class="btn btn-xs btn-success" data-original-title="{{ trans('shared/common.print') }}">
...
<div class="md-modal md-3d-flip-horizontal" id="modal-cancel">
    <div class="md-content">
        <h3 style="padding-bottom: 0px;"><strong>{{ trans('shared/common.cancel') }}</strong> {{ trans('operational/menu.draft-delivery-order') }}</h3>
        <div>
            <div class="row">
                <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).on('ready', function(){
        ...
        $('.cancel-action').on('click', function() {
            ...
            $("#cancel-text").html('{{ trans('purchasing/fields.cancel-confirmation', ['variable' => trans('operational/menu.draft-delivery-order')]) }} ' + $(this).data('label') + '?');
            clearFormCancel()
        });
