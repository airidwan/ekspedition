...
<table class="table" cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <th width="30%">{{ trans('operational/fields.sender') }}</th>
            <th width="10%">{{ trans('operational/fields.total-coly') }}</th>
            <th width="10%">{{ trans('operational/fields.weight') }}</th>
            <th width="20%" rowspan="2">{{ trans('operational/fields.destination-city') }}</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="30%">{{ $line->resi->sender_name }}</td>
            ...
            <td width="20%" rowspan="2">{{ $line->resi->route->cityEnd->city_name }}</td>
