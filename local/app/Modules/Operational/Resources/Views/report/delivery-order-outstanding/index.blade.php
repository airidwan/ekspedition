    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.delivery-order-outstanding') }}</h2>
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="150px">{{ trans('shared/common.action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
...
<div class="md-modal md-3d-flip-horizontal" id="modal-cancel">
    <div class="md-content">
        <h3 style="padding-bottom: 0px;"><strong>{{ trans('shared/common.cancel') }}</strong> {{ trans('operational/menu.delivery-order-outstanding') }}</h3>
        <div>
            <div class="row">
                <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).on('ready', function(){
        ...
        $('.cancel-action').on('click', function() {
            ...
            $("#cancel-text").html('{{ trans('purchasing/fields.cancel-confirmation', ['variable' => trans('operational/menu.delivery-order-outstanding')]) }} ' + $(this).data('label') + '?');
            clearFormCancel()
        });
