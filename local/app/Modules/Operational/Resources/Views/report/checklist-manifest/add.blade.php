...
@section('title', trans('operational/menu.checklist-manifest'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> <strong>{{ $title }}</strong> {{ trans('operational/menu.checklist-manifest') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="{{ url($url . '/save') }}">
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                           <div class="form-group">
                                ...
                                @if ($model->isOtr())
                                <button type="submit" name="btn-arrive" class="btn btn-sm btn-success"><i class="fa fa-download"></i> {{ trans('operational/fields.arrive') }}</button>
                                @endif
                                <a href="{{ URL($url.'/print-pdf-checklist/'.$model->manifest_header_id) }}" class="button btn btn-sm btn-success" target="_blank">
                                    <i class="fa fa-print"></i> {{ trans('operational/fields.checklist') }}
                                </a>
                            </div>
                        </div>
                    </form>
