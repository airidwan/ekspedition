    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> <strong>{{ $title }}</strong> {{ trans('operational/menu.resi-all-branch') }}</h2>
                ...
                <div id="horizontal-form">
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="{{ url($url . '/save') }}">
                        ...
                        <ul id="demo1" class="nav nav-tabs">
                            ...
                            <li class="">
                                <a href="#tabDelivery" data-toggle="tab">{{ trans('operational/fields.delivery') }} <span class="badge badge-primary"></span></a>
                            </li>
                            <li class="">
                                <a href="#tabPayment" data-toggle="tab">{{ trans('operational/fields.payment') }} <span class="badge badge-primary"></span></a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            ?>
                            <div class="tab-pane fade" id="tabNego">
                            ...
                            <div class="tab-pane fade" id="tabDelivery">
                                <div class="col-sm-12 portlets">
                                    <h4 style="margin:0px;">{{ trans('operational/fields.manifest') }}</h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="table-line-unit" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>{{ trans('operational/fields.manifest-number') }}</th>
                                                    <th>{{ trans('operational/fields.status') }}</th>
                                                    <th>{{ trans('operational/fields.driver') }}</th>
                                                    <th>{{ trans('operational/fields.police-number') }}</th>
                                                    <th>{{ trans('operational/fields.shipment-date') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                                $shipmentDate = !empty($data->shipment_date) ? new \DateTime($data->shipment_date) : null;
                                                $arriveDate = !empty($data->arrive_date) ? new \DateTime($data->arrive_date) : null;
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td > {{ !empty($shipmentDate) ? $shipmentDate->format('d-M-Y') : '' }} </td>
                                                        <td > {{ !empty($arriveDate) ? $arriveDate->format('d-M-Y') : '' }} </td>
                                                        <td class="text-right"> {{ number_format($data->coly_sent) }} </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-sm-12 portlets">
                                    <h4 style="margin:0px;">{{ trans('operational/fields.receipt-return-do') }}</h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="table-line-unit" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ trans('operational/fields.police-number') }}</th>
                                                    <th>{{ trans('operational/fields.status') }}</th>
                                                    <th>{{ trans('operational/fields.received-date') }}</th>
                                                    <th>{{ trans('operational/fields.received-by') }}</th>
                                            ...
                                            <tbody>
                                                <?php 
                                                ?>
                                                @foreach($receiptReturnDo as $data)
                                                <?php 
                                                $date = !empty($data->received_date) ? new \DateTime($data->received_date) : null;
                                                ?>
                                                    <tr>
                                                        <td > {{ $data->receipt_or_return_delivery_number }} </td>
                                                        ...
                                                        <td > {{ $data->note }} </td>
                                                        <td class="text-right"> {{ number_format($data->total_coly) }} </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-sm-12 portlets">
                                    <div class="table-responsive">
                                        <h4 style="margin:0px;">{{ trans('operational/fields.goods-expenditure') }}</h4>
                                        <table class="table table-striped table-bordered" id="table-line-unit" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>{{ trans('operational/fields.lge-transact-number') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($lge as $data)
                                                <?php 
                                                $date = !empty($data->created_date) ? new \DateTime($data->created_date) : null;
                                                ?>
                                                    <tr>
                                                        <td > {{ $data->customer_taking_transact_number }} </td>
                                                        <td > {{ $data->taker_name }} </td>
                                                        <td > {{ !empty($date) ? $date->format('d-M-Y') : '' }} </td>
                                                        <td class="text-right"> {{ number_format($data->coly_taken) }} </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                            ...
                            <div class="tab-pane fade" id="tabPayment">
                                <div class="col-sm-12 portlets">
                                    <h4 style="margin:0px;">{{ trans('accountreceivables/fields.invoice') }}</h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="table-line-unit" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>{{ trans('accountreceivables/fields.invoice-number') }}</th>
                                                    ...
                                                    <th>{{ trans('accountreceivables/fields.discount') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td > {{ $data->bill_to_phone }} </td>
                                                        <td class="text-right"> {{ number_format($data->amount) }} </td>
                                                        <td class="text-right"> {{ number_format($data->discount_approved) }} </td>
                                                        <td class="text-right"> {{ number_format($data->total_invoice) }} </td>
                                                        <td class="text-right"> {{ number_format($data->total_receipt) }} </td>
                                                        <td class="text-right"> {{ number_format($data->remaining) }} </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-sm-12 portlets">
                                    <h4 style="margin:0px;">{{ trans('accountreceivables/fields.receipt') }}</h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="table-line-unit" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                           <div class="form-group">
                                ...
                                @if($model->isApproved())
                                    <a href="{{ URL($urlResi . '/print-pdf/' . $model->resi_header_id) }}" target="_blank" data-toggle="tooltip" class="btn btn-sm btn-success" data-original-title="{{ trans('shared/common.print') }}">
                                        <i class="fa fa-print"></i> {{ trans('shared/common.print') }}
                                    </a>
                                    <a href="{{ URL($urlResi . '/print-pdf-tanpa-biaya/' . $model->resi_header_id) }}" target="_blank" data-toggle="tooltip" class="btn btn-sm btn-success" data-original-title="{{ trans('operational/fields.print-tanpa-biaya') }}">
                                        <i class="fa fa-print"></i> {{ trans('operational/fields.print-tanpa-biaya') }}
                                    </a>
                                    <a href="{{ URL($urlResi . '/print-voucher/' . $model->resi_header_id) }}" target="_blank" data-toggle="tooltip" class="btn btn-sm btn-success" data-original-title="{{ trans('operational/fields.print-voucher') }}">
