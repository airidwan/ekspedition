...
@section('title', trans('operational/menu.history-resi'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.history-resi') }}</h2>
                ...
                <div id="horizontal-form">
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            ...
                            <div class="form-group">
                                <label for="transactionName" class="col-sm-4 control-label">{{ trans('shared/common.transaction-name') }}</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="transactionName" name="transactionName" value="{{ !empty($filters['transactionName']) ? $filters['transactionName'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('shared/common.transaction-name') }}</th>
                        ...
                        <tbody>
                            ...
                            <?php $transactionDate = !empty($model->transaction_date) ? \App\Service\TimezoneDateConverter::getClientDateTime($model->transaction_date) : null; ?>
                            <tr>
                                <td class="text-center">{{ $no++ }}</td>
                                <td>{{ $model->transaction_number }}</td>
                                <td>{{ $transactionDate !== null ? $transactionDate->format('d-m-Y H:i:s') : '' }}</td>
                                <td>{{ $model->transaction_name }}</td>
                                <td>{{ $model->description }}</td>
                                <td>{{ $model->user_full_name }}</td>
                                <td>{{ $model->role_name }}</td>
                                <td>{{ $model->branch_name }}</td>
                                <td class="text-center">
                                    <a href="#" data-json="{{ $model->data }}" data-toggle="tooltip" class="btn-data btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
