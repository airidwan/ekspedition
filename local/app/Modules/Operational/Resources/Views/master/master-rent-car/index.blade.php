                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="toolbar-btn-action">
                                        ...
                                        <a href="{{ URL('operational/master/master-rent-car/add') }}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="tect-right">{{ number_format($model->rent_rate,0,".",",") }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ URL($url . '/edit/' . $model->rent_car_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
