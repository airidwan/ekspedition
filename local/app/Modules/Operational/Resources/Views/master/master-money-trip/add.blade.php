    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> <strong>{{ $title }}</strong> {{ trans('operational/menu.money-trip') }}</h2>
            ...
            <div class="widget-content padding">
                <div id="horizontal-form">
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="{{ url($url . '/save') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="id" name="id" value="{{ count($errors) > 0 ? old('id') : $model->money_trip_id }}">
                        ...
                        <div class="col-sm-7 portlets">
                            ...
                            <div class="form-group {{ $errors->has('moneyTrip') ? 'has-error' : '' }}">
                                <label for="moneyTrip" class="col-sm-5 control-label">{{ trans('operational/fields.money-trip') }} <span class="required">*</span></label>
                                <div class="col-sm-7">
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                            <div class="form-group">
                                <a href="{{ URL('operational/master/master-money-trip') }}" class="btn btn-sm btn-warning"><i class="fa fa-reply">
...
<script type="text/javascript">
    $(document).on('ready', function() {
        ...
        $('#datatables-lov tbody').on('click', 'tr', function () {
            ...
            var startCity       = $(this).find('input[name="view-kota-asal[]"]').val();
            var endCity         = $(this).find('input[name="view-kota-tujuan[]"]').val();
