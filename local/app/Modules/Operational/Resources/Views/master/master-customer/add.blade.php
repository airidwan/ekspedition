...
@section('title', trans('operational/menu.customer'))
    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> <strong>{{ $title }}</strong> {{ trans('operational/menu.customer') }}</h2>
                ...
                <div id="horizontal-form">
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="{{ url($url . '/save') }}">
                        ...
                        <ul id="demo1" class="nav nav-tabs">
                            <li class="active">
                                <a href="#customerTab" data-toggle="tab">{{ trans('operational/menu.customer') }} <span class="label label-success"></span></a>
                            </li>
                            <li class="">
                            ...
                            <div class="tab-pane fade active in" id="customerTab">
                                <div class="col-sm-6 portlets">
                                    <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="code" name="code"  value="{{ !empty($model->customer_code) ? $model->customer_code : '' }}" disabled>
                                            @if($errors->has('code'))
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" name="name" value="{{ count($errors) > 0 ? old('name') : $model->customer_name }}">
                                            @if($errors->has('name'))
                                        ...
                                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                if (count($errors) > 0) {
                                                    ...
                                                    $branchDetail   = $model->customerBranch()->get();
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                            <div class="form-group">
                                <a href="{{ URL('operational/master/master-customer') }}" class="btn btn-sm btn-warning"><i class="fa fa-reply"></i> {{ trans('shared/common.cancel') }}</a>
