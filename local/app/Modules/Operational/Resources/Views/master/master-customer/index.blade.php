    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.customer') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="phone" name="phone" value="{{ !empty($filters['phone']) ? $filters['phone'] : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 portlets">
                        ...
                        <div class="col-sm-12 data-table-toolbar text-right">
                            <div class="form-group">
                                ...
                                <a href="{{ URL('operational/master/master-customer/add') }}" class="btn btn-sm btn-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @can('access', [$resource, 'update'])
                                        <a href="{{ URL($url . '/edit/' . $model->customer_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
