    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.region') }}</h2>
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('operational/fields.detail-kota') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $model->region_code }}</td>
                                <td>{{ $model->region_name }}</td>
                                <td>{{ implode(', ', $cityNames) }}</td>
                                ...
                                <td class="text-center">
                                    @can('access', [$resource, 'update'])
                                    <a href="{{ URL($url . '/edit/' . $model->region_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
