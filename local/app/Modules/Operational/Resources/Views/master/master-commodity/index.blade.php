    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.commodity') }}</h2>
                    ...
                    <form  role="form" id="add-form" class="form-horizontal" method="post" action="">
                        ...
                        <div class="col-sm-6 portlets">
                            <div class="form-group">
                                <label for="commodity" class="col-sm-4 control-label">{{ trans('operational/fields.commodity') }}</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="commodity" name="commodity" value="{{ !empty($filters['commodity']) ? $filters['commodity'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="category" id="category">
                                        @foreach($optionCategory as $key => $category)
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="150px">{{ trans('operational/fields.show-on-manifest') }}</th>
                                <th width="150px">{{ trans('shared/common.active') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $model->commodity_name }}</td>
                                <td class="text-center">
                                    <i class="fa {{ $model->show == 'Y' ? 'fa-check' : 'fa-remove' }}"></i>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ URL($url . '/edit/' . $model->commodity_id) }}" data-toggle="tooltip" class="btn btn-xs btn-warning" data-original-title="{{ trans('shared/common.edit') }}">
