    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-header">
                <h2><i class="fa fa-truck"></i> {{ trans('operational/menu.alert-resi-stock') }}</h2>
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('operational/fields.maximum-days') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ number_format($model->minimum_days) }}</td>
