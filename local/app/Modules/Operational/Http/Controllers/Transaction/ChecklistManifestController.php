...
{
    const RESOURCE = 'Operational\Transaction\ChecklistManifest';
    const URL      = 'operational/transaction/cheklist-manifest';
    ...
    public function index(Request $request)
    {
        ...
        return view('operational::transaction.cheklist-manifest.index', [
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('operational::transaction.cheklist-manifest.add', [
    ...
    public function save(Request $request)
    {
        ...
        $request->session()->flash(
            'successMessage',
            trans('shared/common.saved-message', ['variable' => trans('operational/menu.cheklist-manifest').' '.$model->manifest_number])
        );
    ...
    public function printPdfChecklist(Request $request, $id)
    {
        ...
        $html = view('operational::transaction.cheklist-manifest.print-pdf-checklist', [
            'model'  => $model,
            'filters' => $filters,
        ])->render();
